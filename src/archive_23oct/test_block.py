...
class TestBlockchain(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create wallets
        self.sender_wallet = Wallet.load_from_disk("Alice") or Wallet(
            "Alice", 100, self.public_key
        )
        self.recipient_wallet = Wallet.load_from_disk("Bob") or Wallet(
            "Bob", 50, self.public_key
        )
        ...
        self.genesis_block = Block(
            "Genesis Block", None, [], self.private_key_path, self.public_key_path
        )
    ...
    def test_create_transaction(self):
        ...
        success, message = self.genesis_block.add_transaction(
            tx, self.sender_wallet, self.recipient_wallet
        )
